...
Through a long period, I have put a lot of effort into studying to develop back-end web application while referring to lectures and other website posts over and over again. I'm so glad that I finally made my first server-side project, however it still needs a refactoring to make the code more concise. One thing that I've not applied to my project due to the lack of advanced technologies is to analyze survey and predict which item is supposed to be on the result. I realized that I can resolve this problem with a trained machine-learning model. For this reason, I'm going to use a python web framework, Flask to build a new machine learning application next time.
