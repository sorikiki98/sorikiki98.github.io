...
## Before analyzing: MVP Architecture with RxJava ⭐
...
## Step 1. Observables을 반환하는 API들의 집합 Interface 정의(local, remote)
...
## Step 2. DataSource 인터페이스 정의 및 local, remote용 구현체 생성
